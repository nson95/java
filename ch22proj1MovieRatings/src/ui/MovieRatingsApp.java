...
public class MovieRatingsApp {
	...
	public static void main(String[] args) {
		...
		List<Movie> filteredMovies;
			switch (choice) {
				case 1: //Enter Movies
					int nbr = Console.getInt("How many movies would you like to enter? ", 1, 10);
					for (int i=1;i<=nbr;i++) {
						...
						double rating = Console.getDouble("Enter rating: ", 1, 5);
						Movie m = new Movie(title, year, rating);
						mc.add(m);
					}
					break;
				case 2: //List top rated movies
				...
				case 5:
					...
					Console.println("average rating: "+mc.averageRating());
